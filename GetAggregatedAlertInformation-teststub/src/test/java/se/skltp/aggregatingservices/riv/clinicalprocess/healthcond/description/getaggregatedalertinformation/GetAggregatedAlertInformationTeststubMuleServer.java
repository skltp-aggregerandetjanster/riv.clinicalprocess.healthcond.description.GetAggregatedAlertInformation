...
public class GetAggregatedAlertInformationTeststubMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedAlertInformation-teststub";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedAlertInformationTeststubMuleServer.class);
