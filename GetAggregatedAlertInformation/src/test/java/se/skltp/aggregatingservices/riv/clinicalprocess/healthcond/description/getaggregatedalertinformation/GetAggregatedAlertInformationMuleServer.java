...
public class GetAggregatedAlertInformationMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedAlertInformation";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedAlertInformationMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/GetAggregatedAlertInformation-common.xml"
        //
